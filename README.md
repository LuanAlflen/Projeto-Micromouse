...
Anticolisão: Utiliza informações dos sensores ultrassônicos para manter o robô no centro do caminho. Parte do código também define a
User
Complete esse commit com a adição da versão 6.2 no dia 15/11/2023 descrevendo a adição de funções para teste de sensor de linha e uma função para integrar o sensor de linha ao robô
# Projeto Micromouse
